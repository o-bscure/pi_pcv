...
export default class Home extends React.Component {
	...
	var bad_input = /(^\s*$)|(^\s+)/gi
        ...
        if (this.state.isSet == undefined ) {
            var buttonType = "flex place-self-center place-content-center place-items-center bg-gray-600 rounded-md w-1/2 h-12 border-2 font-medium focus:outline-none "
